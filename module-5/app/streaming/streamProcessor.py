...
def retrieveMysfit(mysfitId):
    apiEndpoint = 'https://81ov7xruze.execute-api.us-east-1.amazonaws.com/prod' + '/mysfits/' + str(mysfitId) # eg: 'https://ljqomqjzbf.execute-api.us-east-1.amazonaws.com/prod/'
